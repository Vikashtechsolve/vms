...
const stats = [
  {
    icon: <UsersRound color="#C1272D" fill="#C1272D" className="shrink-0" />,
    value: "10,000 +",
    label: "Skilled Trainers Available",
  },
  {
    icon: <MapPin fill="#fff" color="#C1272D" className="shrink-0" />,
    value: "2,500 +",
    label: "Companies Hiring Trainers",
  },
  {
    icon: <UserRoundCheck fill="#C1272D" color="#C1272D" className="shrink-0" />,
    value: "25,000 +",
    label: "Successful Trainer Placements",
  },
  {
    icon: <CloudCheck color="#C1272D" className="shrink-0" />,
    value: "98%",
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-16 lg:py-20 grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
        <div>
          ...
          <div className="w-24 h-[2px] bg-[#C1272D] mt-6" />
