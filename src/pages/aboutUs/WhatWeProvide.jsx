    ...
    <section className="bg-white py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="bg-[#FFF5F5] rounded-xl p-10 relative">
            {/* Icon */}
            <div className="absolute -top-8 left-1/2 -translate-x-1/2">
              <div className="w-16 h-16 rounded-full bg-[#9C161A] text-white flex items-center justify-center shadow">
                <Users size={28} />
              </div>
            </div>
            ...
            <ul className="mt-8 space-y-4 text-sm text-gray-700">
              <li className="flex gap-3">
                <Check className="text-[#C1272D] mt-1" size={18} />
